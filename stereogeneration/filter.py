...
def substructure_violations(mol):
    ...
    """
    violation = False
    forbidden_fragments = ['[A;R]=[*;R2]', 'a~[*;R2]~a','*1=**=*1', '*=*1*=***=*1', '[c-]' ,'[C-]', '[S-]', '[O-]', '[N-]', '[*+]', '[*-]' '[PH]', '[pH]', '[N&X5]', '*=[S,s;!R]', '[S&X3]', '[S&X4]', '[S&X5]', '[S&X6]', '[P,p]', '[B,b,N,n,O,o,S,s]~[F,Cl,Br,I]', '*=*=*', '*#*', '[O,o,S,s]~[O,o,S,s]', '[N,n,O,o,S,s]~[N,n,O,o,S,s]~[N,n,O,o,S,s]', '[N,n,O,o,S,s]~[N,n,O,o,S,s]~[C,c]=,:[O,o,S,s,N,n;!R]', '*=N-[*;!R]', '*~[N,n,O,o,S,s]-[N,n,O,o,S,s;!R]']
