...
from .alphabet import get_proper_group_grammar
from .group_crossover import crossover_smiles
from .group_mutate import mutate_smiles
...
class GroupJANUS:
    """ JANUS class for genetic algorithm applied on Group-SELFIES
    ...
    def __init__(
        ...
        use_fragments: Optional[bool] = False,
        ...
        # generate group grammar, will include fragments and chiral groups
        # this will work with nonstereo as well, as the generation only depends on the alphabet
        self.group_grammar = get_proper_group_grammar(self.alphabet)

        # make fragments from initial smiles
        # temporarily disable to not clash with chiral groups in alphabet
        self.frag_alphabet = []
